...
The unifying thread: AI agents transforming what's possible, with AWS making it easier to build, deploy, and scale them.
...
The afternoon workshop brought things back to practical cloud ops. The session walked through connecting multiple AWS data sources via S3 buckets and using Amazon Quick as an interactive chat agent capable of querying across them intelligently.
